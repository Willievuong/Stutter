...
"""
    ...
    Arguments: video_url: url to the interview video
               video_format: format of the interview video
               keyword_list: python list of words that are suppose to be included in the user response
...
"""
def autograder(video_url, video_format, keyword_list):
    transcription = video_to_text(video_url, video_format)
    keyword_missed = grade_answer(transcription, keyword_list)
    return keyword_missed
